  ...
  const onUserRegister = async (userObj) => {
   ...
   console.log(profileImageUrl)
    try {
      ...
      let res = await axios.post(`${import.meta.env.VITE_URL}/auth/register`, formData,{withCredentials:true});
      ...
      console.log("URL HIT:", err.config?.url);  // ← this shows EXACT url called
